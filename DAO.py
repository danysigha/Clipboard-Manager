...
class DAO:
	...
	#create and attribute to hold EOF status 
	def __init__(self):
        #-------------------------------------------------
        ...
        try:
			...
			print("Database unavailable for query")
	...
	# to be implemented even more later -> copy card
    def addCard(userID, content, category): 
