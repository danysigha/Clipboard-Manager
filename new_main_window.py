from PyQt5.QtWidgets import QMainWindow, QApplication, QPushButton, \
    ...
    QDialog, QSizePolicy, QStyle, QStackedWidget
...
class UI(QMainWindow):
     ...
     def openWindow(self):
         ...
         window1 = settings.mainSetting()  # page 1
         window2 = settings.setPassword()  # page 2
         window3 = settings.shelftime()  # page 3
         window4 = settings.currentPasswordPage()  # page 4
     ...
     def setupUi(self, MainWindow):
         ...
         self.settings_button = QPushButton(self.right_header_frame, clicked = lambda: self.openWindow()) #
