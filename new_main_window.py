...
class UI(QMainWindow):
    def __init__(self, data_access_object):
        ...
        # load the UI
        # uic.loadUi("test_2.ui", self)
        self.dao = data_access_object


    def openWindow(self, dao):
        self.window = QStackedWidget()
        window1 = settings.mainSetting(MainWindow, self.dao, self.window)  # page 1
        ...
        self.window.setFixedHeight(803)
        self.window.setFixedWidth(789)
...
if __name__ == "__main__":
    ...
    window1 = loginPage.login(dataAccessObject, widget, MainWindow)  # page 1
    window2 = loginPage.newUser(dataAccessObject, widget, MainWindow)
    ...
    qr1 = MainWindow.frameGeometry()
    cp1 = QDesktopWidget().availableGeometry().center()
    qr1.moveCenter(cp)
    MainWindow.move(qr1.topLeft())
