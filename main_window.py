...
################################################################################
## Form generated from reading UI file 'test_2wqajKg.ui'
##
...
"}")
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 200, 777))
        ...
        self.all_cards = QPushButton(self.scrollAreaWidgetContents, clicked = lambda: self.pressit())
        ...
        self.label_16.setMinimumSize(QSize(200, 150))
